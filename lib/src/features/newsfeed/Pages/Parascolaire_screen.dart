...
class ParascolaireScreen extends StatefulWidget {
  const ParascolaireScreen({super.key});

  @override
  State<ParascolaireScreen> createState() => _ParascolaireScreenState();
}

class _ParascolaireScreenState extends State<ParascolaireScreen> {
